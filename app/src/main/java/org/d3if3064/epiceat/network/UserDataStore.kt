...
class UserDataStore(private val context: Context) {
    ...
    val userFlow: Flow<org.d3if3064.epiceat.model.User> = context.dataStore.data.map { preferences ->
        org.d3if3064.epiceat.model.User(
    ...
    suspend fun saveData(user: org.d3if3064.epiceat.model.User) {
